...
function preload(){
  //player assets /anipreload
    ...
    diesImg = loadImage('Assets/player/_DeathNoMovement.png')
    runImg = loadImage('Assets/player/run.png')
    rollImg =loadImage('Assets/player/_Roll.png')
    crouchImg =loadImage('Assets/player/_CrouchFull.png')
    crouchAttackImg =loadImage('Assets/player/_CrouchAttack.png')
    airbornImg =loadImage('Assets/player/_Fall.png')
    jumpImg =loadImage('Assets/player/_Jump.png')
    crouchWalkImg=loadImage('Assets/player/_CrouchWalk.png')
  //health Bar
